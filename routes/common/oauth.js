// file to request the access token from Forge

// This code will store both access tokens on the session (cookie-based)
// with the refresh token and expiration time.
// When it expires, it will use the refresh token to request 2 new access tokens (internal & public).
